    ...
    return (
        <div className='card-wrapper'>
            <PopupState variant="popover" popupId="demo-popup-popover">
                {(popupState) => (
                    <div>
                        <Card sx={{ maxWidth: 345, backgroundColor: '#bd976f' }} style={{ "background": `${props.color}` }} {...bindTrigger(popupState)}>
                            ...
                            <CardActions>
                                {props.isCompleted === false ? <Button size="medium" onClick={() => props.complete(id)}>Complete</Button> : <></>}
                                <Button size="medium" onClick={() => props.delete(id)}>Delete</Button>
                            </CardActions>
                        </Card>
